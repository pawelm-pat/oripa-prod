...
const EN = {
  ...
  chExpireMsg: (n: number, date: string) => `${n.toLocaleString()} Oripa Coins will expire on ${date}!`,
  ...
  chPurchased: "Purchased Oripa Coins",
  chGranted: "Free Points Granted / Refunded",
  chExpired: "Free Points Expired",
