...
const EN = {
  ...
  authConsentRequired: "You must accept the Terms of Service and Privacy Policy.",
  ...
  authExistingBodyEmail: (_email: string) => "Our records show that you already have an account with us. Please log in to your existing account via email.",
  ...
  authPasswordEmailBody: (_email: string) => "We've sent you an email with instructions to set your password.",
  ...
  authPasswordEmailTitle: "Check your email",
...
const JA: Dict = {
  ...
  authCompactGoogleSignup: "Google",
  authCompactLineSignup: "LINE",
  authConsentRequired: "利用規約とプライバシーポリシーへの同意が必要です。",
  ...
  authExistingBodyEmail: (_email: string) => "このメールアドレスはすでに登録されています。既存のアカウントへメールでログインしてください。",
  ...
  authPasswordEmailBody: (email: string) => `${email} にパスワード設定用のご案内を送信しました。`,
  ...
  authPasswordEmailTitle: "メールをご確認ください",
