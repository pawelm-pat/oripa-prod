...
const EN = {
  ...
  storePackSection: "Buy a pack",
  storePackNames: ["Pocket Monsters Pack", "Big Bonanza Pack", "Collector's Vault", "Grand Chase Pack"] as string[],
  storePackCredits: (n: number) => `${n.toLocaleString()} credits`,
  storePackSpins: (n: number) => `${n} spins`,
  storePackMinCard: "min 1 card",
  storePackBigWins: "big wins up to 20 at once",
  storePackBuyOpen: "Buy & open",
...
const JA: Dict = {
  ...
  storePackSection: "パックを購入",
  storePackNames: ["ポケットモンスターパック", "ビッグボナンザパック", "コレクターズボールト", "グランドチェイスパック"] as string[],
  storePackCredits: (n: number) => `${n.toLocaleString()} クレジット`,
  storePackSpins: (n: number) => `${n} スピン`,
  storePackMinCard: "最低1枚",
  storePackBigWins: "最大20枚まで大当たり",
  storePackBuyOpen: "購入して開封",
