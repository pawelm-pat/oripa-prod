...
const EN = {
  ...
  authSeonPhoneBody: "Verify your phone number to complete your signup. You will also receive important account and security messages!",
...
const JA: Dict = {
  ...
  authSeonPhoneBody: "サインアップを完了するため、電話番号を認証してください。重要なアカウント情報およびセキュリティ通知もSMSで受け取れます。",
