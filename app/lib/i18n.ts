...
const EN = {
  ...
  bankTransferWarning: [
    "Processing by financial institutions takes a certain amount of time.",
    "Some financial institutions may not accept payments even if they are made within the stated deadline, so please make your payment as soon as possible.",
    "Please check with your financial institution regarding the timing of the deposit completion.",
    "Please note that your application will be cancelled if payment is not received by the due date.",
  ] as string[],
  bankTransferEmailSent: [
    "We have sent an email to your registered email address regarding payment methods through your virtual account, Aozora.",
    "After the bank transfer is completed, you will receive a payment confirmation email.",
  ] as string[],
  bankTransferNotes: [
    "*Please check your spam folder, as emails may be automatically filtered there.",
    "*Please be sure to open and check the contents of the email once you receive it. Please provide an email address that can be accessed for refunds.",
    "*Please note that the bank transfer fee will be borne by the buyer.",
    "*A different virtual account number will be assigned for each application. Even if you submit multiple applications, the account number you will use for transfers will be different, so please be careful not to make a mistake.",
    "*If the transfer is not processed on the same day by your financial institution after you have made the payment, your order may be cancelled after the payment deadline. Please check with your financial institution in advance to see when the transfer can be reflected by the payment deadline, and make your payment as soon as possible.",
  ] as string[],
...
const JA: Dict = {
  ...
  bankTransferWarning: [
    "金融機関での処理には一定の時間がかかります。",
    "期限内にお振込みいただいた場合でも、金融機関によっては受付できない場合がございますので、お早めにお支払いください。",
    "入金完了のタイミングについては、ご利用の金融機関にご確認ください。",
    "期限までにご入金が確認できない場合、お申し込みはキャンセルとなりますのでご注意ください。",
  ] as string[],
  bankTransferEmailSent: [
    "ご登録のメールアドレスに、バーチャル口座（あおぞら）でのお支払い方法についてのメールをお送りしました。",
    "お振込み完了後、入金確認のメールが届きます。",
  ] as string[],
  bankTransferNotes: [
    "※メールが迷惑メールフォルダに振り分けられる場合がありますので、ご確認ください。",
    "※メールが届きましたら、必ず内容をご確認ください。返金時にご連絡可能なメールアドレスをご登録ください。",
    "※振込手数料はお客様のご負担となります。",
    "※お申し込みごとに異なるバーチャル口座番号が発行されます。複数お申し込みの場合も振込先口座番号はそれぞれ異なりますので、お間違えのないようご注意ください。",
    "※お支払い後、金融機関で当日中に振込処理が行われない場合、お支払い期限を過ぎてご注文がキャンセルとなる場合がございます。期限までに反映されるか、事前にご利用の金融機関にご確認のうえ、お早めにお支払いください。",
  ] as string[],
